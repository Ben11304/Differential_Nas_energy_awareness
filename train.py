...
def main():
    ...
    # criterion= WeightedFocalLoss(class_frequencies).to(device)
...
sampler=torch.utils.data.sampler.SubsetRandomSampler(indices[:split]),
    ...
    for epoch in range(args.epochs):
        ...
        train_top1, train_top5, train_objs =train(train_queue, valid_queue, model, architect, criterion, optimizer, lr, device,args)
